# ¯\_(ツ)_/¯ sklearn Classification Wizard
...
After you run `main.py` in your terminal you can expect to select your targets, answer questions and watch models go through Round 1 & 2.
